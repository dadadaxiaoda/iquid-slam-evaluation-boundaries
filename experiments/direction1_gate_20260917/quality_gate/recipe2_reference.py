...
ROOT=Path(__file__).resolve().parent/'quality_gate'; W=40; START=time.time()
...
for name in ['V101','V102','V201','V103','V202']:
 ...
 paths=[Path('/opt/slam-study/experiments/direction1_gate_20260917/matched')/name/f'{name}_slam_tum.txt',base/'state_groundtruth_estimate0/data.csv',base/'cam0/sensor.yaml',base/'imu0/data.csv']
 paths.extend([Path('/opt/slam-study/experiments/direction1_gate_20260917/matched')/name/'frame_signals.csv',Path('/opt/slam-study/experiments/direction1_gate_20260917/matched')/name/'online_state.csv'])
